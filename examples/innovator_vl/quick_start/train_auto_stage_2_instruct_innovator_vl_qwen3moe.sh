#!/usr/bin/env bash
# ============================================================================
# Stage 2 Instruction Tuning for Innovator-VL 30B-A3B (Qwen3-MoE backbone)
# Adapted from train_auto_stage_1_alignment_innovator_vl_qwen3moe.sh
#
# Differences vs Stage 1.5:
#   - --image-resolution 1000          (higher-resolution SFT)
#   - --weight-decay 0.0
#   - --adam-beta2 0.99
#   - default DATA_PATH points to innovator_instruct_energon (sft schema, multi-image)
#   - default RESUME_FROM_CHECKPOINT points to stage-1.5 save dir
#   - default SAVE_CKPT_PATH = stage_2_instruct_innovator_vl_qwen3moe
#
...
DATA_PATH=${DATA_PATH:-"/jizhicfs/fenghengyi/data/innovator_instruct_energon"}
...
# Resume from the stage-1.5 mid-training checkpoint by default.
RESUME_FROM_CHECKPOINT=${RESUME_FROM_CHECKPOINT:-"/jizhicfs/fenghengyi/innovator_saves/step1/stage_1.5_mid_training_innovator_vl_qwen3moe"}

# Save target
SAVE_CKPT_PATH=${SAVE_CKPT_PATH:-"/jizhicfs/fenghengyi/innovator_saves/step1/stage_2_instruct_innovator_vl_qwen3moe"}
...
# Stage 2 specific training args -- unfreeze ALL modules, hi-res SFT
TRAINING_ARGS=(
...
# Launch
# ---------------------------
echo "Launching Stage 2 Instruction Tuning (Qwen3-MoE) with torchrun:"
