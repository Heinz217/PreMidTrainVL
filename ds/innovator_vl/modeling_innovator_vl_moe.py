...
class InnovatorVlForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, InnovatorVlForConditionalGeneration

        >>> model = InnovatorVlForConditionalGeneration.from_pretrained("Qwen/Qwen2-VL-7B-Instruct")
...
__all__ = ["InnovatorVlForConditionalGeneration", "Qwen2VLModel", "Qwen2VLPreTrainedModel", "Qwen2VLTextModel"]
